...
const symbol = ref(props.params?.symbol || ctx.getGroupSymbol(pg.groupId) || '510050')
...
<template>
  <div class="panel-container">
    <div class="panel-header"><span class="symbol">{{ symbol }} {{ name }}</span><span class="badge">期权</span></div>
