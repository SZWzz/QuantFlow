...
const symbol = ref(props.params?.symbol || ctx.getGroupSymbol(pg.groupId) || '000300')
...
<template>
  <div class="panel-container">
    <div class="panel-header"><span class="symbol">{{ symbol }} {{ name }}</span><span class="badge">指数</span></div>
