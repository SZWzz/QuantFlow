...
const symbol = ref(props.params?.symbol || ctx.getGroupSymbol(pg.groupId) || 'RB')
...
<template>
  <div class="panel-container">
    <div class="panel-header"><span class="symbol">{{ symbol }} {{ name }}</span><span class="badge">期货</span></div>
