...
.save-input { flex: 1; padding: 6px 10px; background: var(--color-bg-input); border: 1px solid var(--color-border); border-radius: 4px; color: var(--color-text-primary); font-size: 12px; outline: none; }
.save-btn { padding: 6px 14px; background: var(--color-accent); color: #fff; border: none; border-radius: 4px; cursor: pointer; font-size: 12px; font-weight: 600; }
...
.rename-input { width: 100%; padding: 2px 6px; background: var(--color-bg-input); border: 1px solid var(--color-accent); border-radius: 3px; color: var(--color-text-primary); font-size: 13px; outline: none; }
.wf-meta { font-size: 10px; color: var(--color-text-tertiary); margin-top: 2px; }
.wf-item-actions { display: flex; gap: 4px; flex-shrink: 0; }
.wf-act-btn { background: none; border: 1px solid var(--color-border); border-radius: 3px; color: var(--color-text-tertiary); cursor: pointer; font-size: 11px; padding: 2px 6px; }
