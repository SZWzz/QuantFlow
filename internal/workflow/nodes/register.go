...
func RegisterAll(r *workflow.NodeRegistry) {
	...
	r.RegisterWithCategory("market_scanner", NewMarketScannerNode, "data")
	r.RegisterWithCategory("watchlist", NewWatchlistNode, "data")
	r.RegisterWithCategory("trade_history", NewTradeHistoryNode, "data")
	r.RegisterWithCategory("orderbook_depth", NewOrderbookDepthNode, "data")
	r.RegisterWithCategory("funding_rate", NewFundingRateNode, "data")
	r.RegisterWithCategory("liquidations", NewLiquidationsNode, "data")
