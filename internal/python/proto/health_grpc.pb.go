...
const (
	HealthService_Ping_FullMethodName      = "/quantflow.HealthService/Ping"
	HealthService_GetStatus_FullMethodName = "/quantflow.HealthService/GetStatus"
)
...
//
// HealthService provides liveness and status checks for the Python sidecar.
...
func (c *healthServiceClient) GetStatus(ctx context.Context, in *GetStatusRequest, opts ...grpc.CallOption) (*StatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedHealthServiceServer) GetStatus(context.Context, *GetStatusRequest) (*StatusResponse, error) {
...
var HealthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "quantflow.HealthService",
